...
class TestProjectCreateWithInvalidData:
        ...
        @allure.link('https://example.com/docs/create_project', name='Документация-12')
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-13')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-14')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-15')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-16')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
...
class TestProjectCreateWithVariantData:
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-17')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
...
class TestProjectCreateWithTheSameData:
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-18')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-19')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
...
class TestProjectCopy:
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-20')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-21')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
...
class TestProjectCreateAndDelete:
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-22')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
