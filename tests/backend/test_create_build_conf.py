...
class TestBuildCreateWithInvalidData:
        ...
        @allure.link('https://example.com/docs/create_project', name='Документация-1')
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-2')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-3')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-4')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
...
class TestBuildConfCreateWithoutObligatoryFields:
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-5')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-6')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
...
class TestBuildConfCreateWithAlreadyUsedIdAndName:
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-7')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-8')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
...
class TestBuildConfCopy:
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-9')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-10')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
...
class TestBuildConfCreateDeleteAndGetInfo:
        ...
        @allure.severity(allure.severity_level.CRITICAL)
        @allure.link('https://example.com/docs/create_project', name='Документация-11')
        @allure.issue('https://issue.tracker/project/123', name='Баг-трекер')
